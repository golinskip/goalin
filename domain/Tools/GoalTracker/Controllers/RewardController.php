...
use Domain\Tools\GoalTracker\Requests\StoreRewardRequest;
use Domain\Tools\GoalTracker\Requests\UpdateRewardRequest;
...
class RewardController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('tools/goal-tracker/rewards/index', [
    ...
    public function create(Request $request): Response
    {
        ...
        return Inertia::render('tools/goal-tracker/rewards/create', [
            'currency' => $setting?->currency?->value ?? Currency::Euro->value,
            'currencySymbol' => $setting?->currency?->symbol() ?? Currency::Euro->symbol(),
    ...
    public function edit(Request $request, Reward $reward): Response
    {
        ...
        return Inertia::render('tools/goal-tracker/rewards/edit', [
            'reward' => [
                'id' => $reward->id,
                'name' => $reward->name,
                'picture' => $reward->picture ? Storage::url($reward->picture) : null,
