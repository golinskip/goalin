...
use Domain\Tools\GoalTracker\Requests\StoreGoalRequest;
use Domain\Tools\GoalTracker\Requests\UpdateGoalRequest;
...
class GoalController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('tools/goal-tracker/goals/index', [
    ...
    {
        return Inertia::render('tools/goal-tracker/goals/create');
    }
    ...
    public function edit(Goal $goal): Response
    {
        ...
        return Inertia::render('tools/goal-tracker/goals/edit', [
            'goal' => [
                'id' => $goal->id,
                'name' => $goal->name,
                'description' => $goal->description,
