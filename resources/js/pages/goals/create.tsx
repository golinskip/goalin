...
const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Goals', href: goalsIndex() },
    { title: 'Create', href: '/goals/create' },
];
                        ...
                        <form onSubmit={submit} className="space-y-6">
                            <div className="grid gap-2">
                                ...
                                <Input
                                    ...
                                    placeholder='e.g. "Increasing focus" or "Better health"'
                                    required
                                />
                                <p className="text-xs text-muted-foreground">
                                    Goals can be broad and aspirational. Activities you create will be linked to goals.
                                </p>
                            ...
                            <div className="flex items-center gap-3 pt-2">
                                ...
                                <Button variant="ghost" asChild>
                                    <Link href={goalsIndex()}>Cancel</Link>
                                </Button>
                            </div>
                        </form>
                    </div>
