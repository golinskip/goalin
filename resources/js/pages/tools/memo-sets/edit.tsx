...
export default function MemoSetEdit({ memoSet }: Props) {
    const breadcrumbs: BreadcrumbItem[] = [
        { title: 'Memo Cards', href: memoSetsIndex() },
        { title: 'Edit', href: `/memo-sets/${memoSet.id}/edit` },
    ];
    ...
    function submit(e: React.FormEvent) {
        e.preventDefault();
        put(`/memo-sets/${memoSet.id}`);
    }

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Edit Memo Set" />
            ...
            <div className="relative flex h-full flex-1 flex-col">
                ...
                <div className="relative z-10 mx-auto flex w-full max-w-2xl flex-1 flex-col gap-6 p-4 lg:p-6">
                    <h1 className="text-2xl font-semibold">Edit Memo Set</h1>
