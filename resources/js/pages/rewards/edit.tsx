...
export default function RewardEdit({ reward, currencySymbol, multiplier }: Props) {
    const breadcrumbs: BreadcrumbItem[] = [
        { title: 'Rewards', href: rewardsIndex() },
        { title: 'Edit', href: `/rewards/${reward.id}/edit` },
    ];
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="relative flex h-full flex-1 flex-col">
                ...
                <div className="relative z-10 mx-auto flex w-full max-w-2xl flex-1 flex-col gap-6 p-4 lg:p-6">
                    <h1 className="text-2xl font-semibold">Edit Reward</h1>
